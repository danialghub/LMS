    ...
    return (
        <div className='flex flex-col gap-4 sm:gap-6 lg:flex-1 rounded-lg lg:sticky lg:top-24 max-lg:mx-auto max-lg:w-full'>
          ...
          <div className='max-lg:w-full mobile-tall:flex max-lg:justify-center'>
              <div className='relative p-3 sm:p-5  sm:w-2/3 lg:w-full rounded-xl mx-6 sm:mx-0 bg-white shadow-md'>
                <input
                    type="text"
            ...
            {/*Mobile دکمه های */}
            <div className='lg:hidden flex  items-center justify-center gap-4 text-[14px] md:text-lg text-black/70  mt-2 font-heading'>
                <button
                    onClick={() => setShowFilters(true)}
                    className='flex items-center justify-center gap-2  w-[150px] md:w-[250px] py-2.5 rounded-md border-1 border-black/5 shadow active:scale-105 transition duration-300'>
                    <Filter size={15} />
                    فیلتر
                </button>
                <button
