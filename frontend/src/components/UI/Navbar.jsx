        ...
        <div className='mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex items-center justify-between h-16 md:h-20'>
              ...
              {authUser ? (
                ...
                <div className="relative" ref={dropdownRef}>
                  <button
                    ...
                    className="group flex items-center gap-3 bg-gradient-to-r from-slate-50 to-white 
                      hover:from-slate-100 hover:to-slate-50 border border-slate-200 rounded-2xl 
                      px-4 py-2 transition-all duration-300 hover:shadow-md"
                  >
            ...
            <button
              ...
              className="md:hidden relative z-20 p-2 rounded-lg bg-white border border-slate-200 
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <div className="fixed top-0 left-0 right-0 bottom-0 bg-white z-40 md:hidden 
              animate-in slide-in-from-top duration-300 overflow-y-auto">
              ...
              <div className="pt-20 px-4 pb-8">
                ...
                <Link
                  to="/courses"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="flex items-center justify-between p-4 mb-3 bg-slate-50 rounded-2xl 
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-right">
                      <p className="font-semibold text-slate-700">دوره‌ها</p>
                      <p className="text-xs text-slate-500">مشاهده همه دوره‌ها</p>
                    </div>
                  </div>
                  ...
                  <>
                    ...
                    >
                      <button className="w-full flex items-center gap-3 p-4 bg-gradient-to-r from-emerald-50 to-emerald-100 
                        ...
                        <div className="text-right flex-1">
                          <p className="font-bold text-slate-700">ورود به عنوان دانشجو</p>
                          <p className="text-xs text-slate-600">دسترسی به دوره‌های ثبت‌نامی</p>
                        </div>
                      </button>
                    </Link>
                    ...
                    >
                      <button className="w-full flex items-center gap-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-100 
                        ...
                        <div className="text-right flex-1">
                          <p className="font-bold text-slate-700">ورود به عنوان مدرس</p>
                          <p className="text-xs text-slate-600">مدیریت و ایجاد دوره</p>
                        </div>
                      </button>
                    </Link>
                  </>
